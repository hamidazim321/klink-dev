...
export default function SideBar({closeBar, open}) {
  ...
  return (
    ...
    className="border border-2 width-75 p-3 width-s-50 width-md-25 width-lg-25 position-fixed z-3 bg-white left-0 top-0 inLeft"
    >
      <div className="d-flex justify-content-between align-items-center border-bottom py-3">
        <FaUserCircle className="fs-1" />
        <CloseButton className="fs-3" onClick={closeBar} />
      </div>
      <Stack>
